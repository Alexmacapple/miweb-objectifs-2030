...
# PDG-LARGE-FILE-JUSTIFICATION: tests de contrat copiés de la V1 pour garantir que la V2 conserve le même comportement de publication.
...
class SiteContractsTest(unittest.TestCase):
    ...
    def test_slideshow_has_accessible_fullscreen_control(self):
        self.assertIn('<h2 id="diaporama-title">Présentation MiWeb V2</h2>', self.index_html)
    ...
    def test_all_slides_url_and_footer_link_show_every_slide(self):
        ...
        self.assertIn(
            '<a class="fr-footer__content-link" href="miweb-objectifs-2030-v2/?slides=all#diaporama">Afficher toutes les slides</a>',
            self.root_html,
        )
    ...
    def test_pages_use_local_official_favicon(self):
        ...
        self.assertIn(
            '<link rel="icon" href="miweb-objectifs-2030-v2/assets/favicons/favicon.ico" type="image/vnd.microsoft.icon">',
            self.root_html,
        )
    ...
    def test_header_tools_use_dsfr_quick_access_group(self):
        ...
        self.assertIn(
            '<a href="assets/downloads/miweb-objectifs-2030-v2-slides.zip" class="fr-btn fr-icon-download-line fr-btn--icon-left" download>Télécharger les slides</a>',
            self.index_html,
        )
    ...
    def test_footer_keeps_only_main_links_without_bottom_separator(self):
        ...
        self.assertIn(
            '<a class="fr-footer__content-link" href="miweb-objectifs-2030-v2/?projection=1#slide-01">Présentation plein écran</a>',
            self.root_html,
        )
    ...
    def test_slide_alternative_buttons_include_slide_titles(self):
        ...
        self.assertIn("Lire l’alternative textuelle de la slide 10 - Piloter avec des indicateurs consolidables", self.index_html)
        self.assertNotIn("Lire l’alternative textuelle de la slide 10 -  - Piloter avec des indicateurs consolidables", self.index_html)
    ...
    def test_slide_figures_have_short_numbered_caption_relationship(self):
        ...
        self.assertIn('<figcaption class="miweb-slide-caption">Slide 10 sur 10</figcaption>', self.index_html)
        self.assertNotIn('<figcaption class="miweb-slide-caption">Slide 10 sur 10 - Piloter avec des indicateurs consolidables</figcaption>', self.index_html)
