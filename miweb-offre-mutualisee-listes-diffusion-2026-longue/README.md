...
Site statique GitHub Pages pour les slides accessibles « Offre mutualisée de listes de diffusion ».
...
Le script lit `slides.json` et génère `index.html`, `alternatives.html`, `accessibilite.html`, `alternatives.md` et `assets/downloads/miweb-offre-mutualisee-listes-diffusion-2026-longue-slides.zip`.

## Sources de la version longue
