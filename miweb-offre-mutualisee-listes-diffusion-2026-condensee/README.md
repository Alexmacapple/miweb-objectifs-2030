...
Le script lit `slides.json` et génère `index.html`, `alternatives.html`, `accessibilite.html`, `alternatives.md` et `assets/downloads/miweb-offre-mutualisee-listes-diffusion-2026-condensee-slides.zip`.
