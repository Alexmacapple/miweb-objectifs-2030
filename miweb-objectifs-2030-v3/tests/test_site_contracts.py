...
# PDG-LARGE-FILE-JUSTIFICATION: tests de contrat copiés de la V2 pour garantir que la V3 conserve le même comportement de publication.
...
class SiteContractsTest(unittest.TestCase):
    ...
    def test_slideshow_has_accessible_fullscreen_control(self):
        self.assertIn('<h2 id="diaporama-title">Présentation MiWeb V3</h2>', self.index_html)
    ...
    def test_all_slides_url_and_footer_link_show_every_slide(self):
        ...
        self.assertIn(
            '<a class="fr-footer__content-link" href="miweb-objectifs-2030-v3/?slides=all#diaporama">Afficher toutes les slides</a>',
            self.root_html,
        )
    ...
    def test_pages_use_local_official_favicon(self):
        ...
        self.assertIn(
            '<link rel="icon" href="miweb-objectifs-2030-v3/assets/favicons/favicon.ico" type="image/vnd.microsoft.icon">',
            self.root_html,
        )
    ...
    def test_header_tools_use_dsfr_quick_access_group(self):
        ...
        self.assertIn(
            '<a href="assets/downloads/miweb-objectifs-2030-v3-slides.zip" class="fr-btn fr-icon-download-line fr-btn--icon-left" download>Télécharger les slides</a>',
            self.index_html,
        )
    ...
    def test_footer_keeps_only_main_links_without_bottom_separator(self):
        ...
        self.assertIn(
            '<a class="fr-footer__content-link" href="miweb-objectifs-2030-v3/?projection=1#slide-01">Présentation plein écran</a>',
            self.root_html,
        )
