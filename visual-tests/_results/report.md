# Rapport visuel ShipGuard - 2026-06-30 08:42:41
...
|---|---:|---:|---|---|
| pages/checklist-span-operationnel-accessibilite-html | PASS | 2.7s | Accessibilité - Checklist SPAN opérationnel - page accessibilité | capture disponible |
...
| pages/mise-en-gouvernance-du-span-alternatives-html | PASS | 1.2s | Alternatives textuelles - Mise en gouvernance du SPAN - alternatives textuelles | capture disponible |
| pages/mise-en-gouvernance-du-span | PASS | 1.2s | Mise en gouvernance du SPAN - présentation | capture disponible |
...
| pages/miweb-objectifs-2030-v4 | PASS | 1.2s | Objectifs 2030 - accessibilité numérique - présentation | capture disponible |
...
| pages/miweb-offre-mutualisee-listes-diffusion-2026-condensee | PASS | 1.2s | Offre mutualisée de listes de diffusion - présentation | capture disponible |
