#!/usr/bin/env python3
# PDG-LARGE-FILE-JUSTIFICATION: générateur autonome copié de la V3 pour que la V4 reste publiable et vérifiable sans dépendre d’un outillage racine non stabilisé.
